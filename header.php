        ...
        <nav class="navbar fixed-top navbar-expand-lg bg-light">
            <div class="profilebar d-flex ">
                ...
                <ul class="d-flex align-items-center me-auto mt-3 mr-3 mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#"><img id="user-icon" src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt=""><span><?php echo $_SESSION['u_name']?></span></a>
                    </li>
                    <li class="nav-item">
